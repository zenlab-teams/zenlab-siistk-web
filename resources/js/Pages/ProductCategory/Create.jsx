...
const ProductCategoryCreate = ({ flash, products }) => {
    ...
    return (
        <Layout flash={flash}>
            <Head>
                <title>Tambah Kategori Produk | TelatenKarya</title>
            </Head>
            <Sidebar />
            <section className="sm:ml-80 p-8 relative">
                <div className="mb-5">
                    <h1 className="text-3xl font-bold">Kategori Produk</h1>
                    <p className="text-slate-500 text-lg">Tambah Kategori Produk Baru</p>
                </div>
                <div className="bg-white dark:bg-slate-800 shadow-lg p-5 rounded-xl">
                    <div className="flex justify-between items-center mb-3">
                        <p className="text-xl font-bold">Tambah Kategori Produk</p>
                        <Link
